...
const evenimenteIstorice = [  
{
  ...
  note: 'Facultatea de Fizică, Matematică și Tehnologii Informaționale a Universității Pedagogice de Stat "Ion Creangă" din Chișinău a organizat cu succes "Olimpiada interuniversitară de informatică – ediția a XV-a", un eveniment academic dedicat studenților pasionați de informatică, programare și tehnologii informaționale.<br><br>Evenimentul a fost organizat de către Catedra Informatică și Tehnologii Informaționale, una dintre subdiviziunile academice importante ale facultății.<br><br><b>Cadre didactice organizatoare:</b><br>• Liubomir Chiriac – doctor habilitat, profesor universitar, șef de catedră;<br>• Andrei Braicov – profesor universitar, decan al facultății;<br>• Angela Globa, Ala Gașnaș, Natalia Joșu, Maria Pavel, Teodora Vascan – doctori, conferențiari;<br>• Marina Bostan, Olesea Sîrghi – lectori universitari.<br><br><b>Rezultate studenți UPSC:</b><br>Anul I:<br>- Goncear Vladimir – locul II;<br>- Didic Victoria, Movilă Ștefan, Sandu Mihai – locul III;<br>- Buză Maria-Magdalena – mențiune.<br><br>Anul II–IV:<br>- Sandu Florin – locul I;<br>- Cantea Aura, Sârbu Daniela, Păduraru Laurențiu – locul II;<br>- Zalevschi Pavel, Josan Alexandru, Grecica Maxim, Zugravu Nicoleta, Pleșca Alexandrina – locul III;<br>- Șipitca Sergiu, Poșcai Anastasia, Lungu Loredana, Benderscaia Iulia, Midari Denis, Gudumac Ecaterina – mențiune.'
},
  {
